...
public:
    ...
    int pop() {
        ...
        int last_mainStack_value;
        while (!mainStack.empty())
        {
            int mainStack_value = mainStack.top();
            mainStack.pop();
            if(mainStack.empty())
            {
                last_mainStack_value = mainStack_value;
                break;
            }
            copyStack.push(mainStack_value);
        }
