...
public:
    ...
    int pop() {
        queue<int> copyQueue;
        int last_mainQueue_value;
        while(!mainQueue.empty())
        {
            int mainQueue_value = mainQueue.front();
            mainQueue.pop();
            if (mainQueue.empty())
            {
                last_mainQueue_value = mainQueue_value;
                break;
            }
            copyQueue.push(mainQueue_value);
        }
        mainQueue = copyQueue;
        return last_mainQueue_value;
    }
